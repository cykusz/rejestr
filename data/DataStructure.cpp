...
DataStructure::initStructure()
{
    ...
    query.exec("CREATE TABLE \"sprawy_wejscie\" (\"data_wejscia\" DATETIME NOT NULL , \"nr_he\" VARCHAR NOT NULL , \"id_jednostka\" INTEGER NOT NULL , \"nr_rsd\" VARCHAR NOT NULL , \"opis\" TEXT, \"id_przydzial\" INTEGER NOT NULL , \"rodzaj\" VARCHAR NOT NULL , \"data_zabezpieczenia\" DATETIME NOT NULL , \"uwagi\" TEXT)");
}
