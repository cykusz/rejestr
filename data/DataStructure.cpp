...
DataStructure::initStructure()
{
    ...
    query.exec("CREATE TABLE IF NOT EXISTS \"pracownicy\" (\"imie\" VARCHAR NOT NULL , \"nazwisko\" VARCHAR NOT NULL , \"inicjaly\" VARCHAR NOT NULL ,\"k\" BOOL NOT NULL , \"uk\" BOOL NOT NULL , \"w\" BOOL NOT NULL )");
}
